...
public class AsyncNetworkFileDownload extends AsyncTask<String, Void, Boolean> {
    private final String TAG = "AsyncNetworkFileDL";
    ...
    /** */
    public AsyncNetworkFileDownload(String url, File outFile, CountDownLatch latch) {
        urlString = url;
        outputFile = outFile;
        mLatch = latch;
    }
